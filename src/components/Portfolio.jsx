      ...
      <div className="container">
        ...
        <div className="col-md-4">
            <a href="https://squad-sync-5e36d690cf8e.herokuapp.com/" className="work-link">
              <div className="card">
                <img src="https://ibb.co/SXKqytn" className="card-img-top" alt="Note Taker App" />
          ...
          <div className="col-md-4">
            <a href="https://challenge-fitness-9cf387429034.herokuapp.com/login" className="work-link">
              <div className="card">
                <img src="https://ibb.co/McZzKs4" className="card-img-top" alt="Challenge Fitness App" />
                <div className="card-body">
          ...
          <div className="col-md-4">
            <a href="https://sparkkyjd.github.io/Marvel-comic-search/" className="work-link">
              <div className="card">
                <img src="https://ibb.co/G9MfbDR" className="card-img-top" alt="Marvel Longbox App" />
                <div className="card-body">
